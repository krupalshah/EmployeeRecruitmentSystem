...
#apDiv4 a:hover{background: #FFFFB7; color:#111}
...
#apDiv13 table tr td a:hover{
	color: #111;
	text-transform: capitalize;	
}

#apDiv13 table tr td.my2{
	background-color: #6A6AD2;
	width: 20px;
	
}
#apDiv13 table tr td.my3{
	background-color: #0C96B4;
	width: 20px;
}
#apDiv13 table tr td.my4{
...
<div id="apDiv13">
  <table width="100%" height="100%" align="center"  cellpadding="20px"  cellspacing="20px">
  <tr>
      <td class="my4"><a href="viewpersonal.php">personal profile</a></td>
   ...
   <tr>
      ...
      <td class="my3"><a href="viewacademic.php">academic profile</a></td>
    </tr>
      <tr>
      ...
      <td class="my2"><a href="viewaccount.php">account profile</a></td>
    </tr>
