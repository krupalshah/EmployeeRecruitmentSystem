...
#apDiv2 table{
	...
	text-transform: capitalize;
	color: seashell;
	text-align: center; border-width: thin; border:#000;
}
...
<div id="apDiv2">
  <table width="808" height="468" cellpadding="10" cellspacing="5" border="1">
    <tr>
      <th scope="col">post name</th>
      <th scope="col">vacancies</th>
      <th scope="col">required experience</th>
      <th scope="col">approx salary</th>
    </tr>
    <tr>
      <th scope="row">web developer</th>
      <td>
	  <?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'Web Developer'" ;
      ...
      <td>  <?php
	   ...
	   $result=mysql_query($query);
	    ...
	    $row=mysql_fetch_array($result);
		  ...
		  echo $row['minsalary']." - ".$row['maxsalary'];
    ...
    <tr>
      ...
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'Mobile App Developer'" ;
	   $result=mysql_query($query);
    ...
    <tr>
      <th scope="row">database administrator</th>
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'DataBase Administrator'" ;
	   $result=mysql_query($query);
    ...
    <tr>
      <th scope="row">search engine optimizer</th>
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'Search Engine Optimizer'" ;
	   $result=mysql_query($query);
    ...
    <tr>
      ...
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'Product Manager'" ;
	   $result=mysql_query($query);
    ...
    <tr>
      ...
      <td><?php
       $query ="SELECT * FROM `requirement` WHERE `postname`= 'HR Manager'" ;
	   $result=mysql_query($query);
